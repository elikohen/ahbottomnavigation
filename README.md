...
## What's new (1.5.2) - [Changelog](https://github.com/aurelhubert/ahbottomnavigation/blob/master/CHANGELOG.md)
...
```groovy
dependencies {
    compile 'com.github.elikohen:ahbottomnavigation:1.5.2'
}
```
### XML
```xml
